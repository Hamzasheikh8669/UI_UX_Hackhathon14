    ...
    specs: [
      {
        ...
        value2: "1 (head+table, 2 single)",
      },
      {
        label: "Model Number",
        value1: "7CH-Unassembled",
        value2: "7CH-Unassembled",
      },
      {
      ...
      },
      {
        ...
        value1: "Bright Grey & Iron",
        value2: "Bright Grey & Iron",
      },
    ],
  },
  {
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      {comparisonData.map((section, sectionIndex) => (
        <div key={`section-${sectionIndex}`} className="mt-20 first:mt-12">
          <h4 className="font-semibold text-2xl text-[#000000] mb-8">
            {section.title}
          </h4>
